...
function thundercats() {
    ...
    d.innerHTML = '<a href="/donate?utm_campaign=catalyst' + banners[i][0] + '&utm_source=support&utm_medium=banner" style="color:#ffff00; text-decoration:none;"><strong><span style="color:#000">Catalyst Grants:</span> <span style="text-shadow: 0 -1px 0 #258ab9">' + banners[i][1] + '</span></strong> <span style="color:#000">&mdash; Donate Now</span></a>';
